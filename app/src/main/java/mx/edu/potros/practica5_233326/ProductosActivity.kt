...
class ProductosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var adaptador: AdaptadorProductos =
            AdaptadorProductos(this, menu)
        listview.adapter = adaptador

        var imagen: ImageView = findViewById(R.id.imageView3)
        when(menuOption) {
            "Antojitos" -> {
        ...
        when(option) {
            "Antojitos" -> {
                ...
                menu.add(Product("Tostadas",
                    ...
                    4.59))
                menu.add(Product("Coctel Mixto",
                    R.drawable.coctel,
                    "",
                    21.99))
                menu.add(Product("Coctel de Camaron",
                    R.drawable.coctel,
                    "Shrimp cocktail",
                    16.49))
            }
            "Especialidades" -> {
                menu.add(Product("Mojarra Frita - Fried Fish",
                    R.drawable.mojarra,
                    ...
                    17.99))
                menu.add(Product("Ceviche",
                    R.drawable.ceviche,
                    "Tilapia, camarones, Aguacate y pico de gallo servido con Chips / Tilapia, Shrimp, Avocado and pico de gallo, served with Chips",
                    6.99))
                menu.add(Product("Botana de Camarones al Mojo de Ajo",
                    R.drawable.botanacamarones,
                    "",
                    19.99))
                menu.add(Product("Botana de Camarones a la Diabla",
                    R.drawable.botanacamarones,
                    "",
                    19.99))
                menu.add(Product("Torre de Camarón Negro",
                    R.drawable.caldocamaron,
                    "",
                    16.99))
                menu.add(Product("Botana de Pulpo a la Diabla",
                    R.drawable.botanacamarones,
                    ...
                    24.99))
                menu.add(Product("Botana de Pulpo al Mojo de Ajo",
                    R.drawable.botanacamarones,
                    "Servido totopos, cebolla frita, arroz, lechuga y pico de gallo - Served with chips, grill onions, rice, lettuce and pico de gallo.",
                    24.99))
                menu.add(Product("Pulpo al Mojo de Ajo",
                    R.drawable.sopamariscos,
                    "",
                    35.00))
                menu.add(Product("Pulpo Zarandeado",
                    R.drawable.sopamariscos,
                    "",
                    35.00))
                menu.add(Product("Platillos de Camarón al Mojo de Ajo",
                    R.drawable.botanacamarones,
                    "",
                    18.99))
                menu.add(Product("Platillos de Camarón a la Diabla",
                    R.drawable.botanacamarones,
                    "",
                    18.99))
            }
            "Combinations" -> {
                menu.add(Product("Traditional Taco Combo",
                    ...
                    6.99))
                menu.add(Product("Mexican Burritos",
                    ...
                    12.99))
                menu.add(Product("Los Portales Burrito",
                ...
                menu.add(Product("Burrito Pepe",
                    ...
                    9.99))
                menu.add(Product("Fajita Burrito",
                    R.drawable.burritos,
                    ...
                    13.59))
                menu.add(Product("Fajita Quesadilla",
